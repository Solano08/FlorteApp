...
export const normalizeProfileMedia = (entity) => ({
    ...entity,
    avatarUrl: resolveAssetUrl(entity.avatarUrl),
    coverImageUrl: resolveAssetUrl(entity.coverImageUrl)
});
export const normalizeAuthUserMedia = (user) => normalizeProfileMedia(user);
export const normalizeProfile = (profile) => normalizeProfileMedia(profile);
export const normalizeFeedAuthor = (author) => ({
    ...author,
    avatarUrl: resolveAssetUrl(author.avatarUrl)
});
export const normalizeFeedAttachment = (attachment) => ({
    ...attachment,
    url: resolveAssetUrl(attachment.url) ?? attachment.url
});
export const normalizeFeedComment = (comment) => ({
    ...comment,
...
export const normalizeFeedReport = (report) => ({
    ...report,
