      ...
      <label className="flex flex-col gap-2 text-sm font-medium text-[var(--color-text)]">
        ...
        <input
          ...
          className={classNames(
            'rounded-2xl border border-white/25 bg-white/20 backdrop-blur-md px-3 py-2 text-xs text-[var(--color-text)] outline-none transition-all focus:border-sena-green focus:ring-2 focus:ring-sena-green/30 dark:border-white/15 dark:bg-white/10',
